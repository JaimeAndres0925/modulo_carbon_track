...
class CarbonTRackEmision(models.Model):
    ...
    region = fields.Char(string='País / Región', help="Código ISO o nombre de la región")
    anio = fields.Char(string='Año de Publicación')
    fuente_origen = fields.Char(string='Fuente Oficial', help="Entidad que publica el dato (ej. MITECO, EPA)") 
